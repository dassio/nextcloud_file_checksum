...
class Version000000Date20200819193800 extends SimpleMigrationStep
{

  /**
   * @param IOutput $output
   * @param Closure $schemaClosure The `\Closure` returns a `ISchemaWrapper` extends SimpleMigrationStep {
