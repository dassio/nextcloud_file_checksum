...
class FilesChecksumApiController extends ApiController
{
	...
	public function __construct($AppName, IRequest $request,
		...
		IDBConnection $db,ScannedFileMapper $scannedMapper)
	{
	...
	public function getChecksumStatisticStatus(): JSONResponse{
		...
		$progress = checkScanFinished() ? "finished" : "not_finished";
		$result[] = ["fileNum"=>count($files),"progress"=>$progress];
		return new JSONResponse($result, Http::STATUS_OK);
	}
